...
export default class HubCreation extends React.Component {
  constructor() {
    super();
    this.state = {
      error: '',
  ...
  onAddHub = (e) => {
    e.preventDefault();
        const form = document.forms.createHubForm;
  ...
  render() {
    ...
    return (
      <>
        <h2 style={{ textAlign: 'center' }}>Create New Hub</h2>
        <form
          name='createHubForm'
          onSubmit={this.onAddHub}
